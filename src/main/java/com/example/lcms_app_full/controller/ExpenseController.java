...
import com.example.lcms_app_full.dto.ExpenseDto;
import com.example.lcms_app_full.service.ExpenseService;
...
public class ExpenseController {
    ...
    public ResponseEntity<ApiResponse> getAll(@RequestParam(defaultValue = "0") int page,@RequestParam(defaultValue = "10") int size,
                                              @RequestParam(value = "expense",defaultValue = "") String expenseName,
                                              @RequestParam(value = "filial",defaultValue = "") String filialName,
                                              @RequestParam(value = "pay",defaultValue = "") String payType,
                                              @RequestParam(value = "category",defaultValue = "") String expenseType
                                              ){
        ApiResponse response = expenseServise.getall(page,size,expenseName,filialName,payType,expenseType);
